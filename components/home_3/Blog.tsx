            ...
            <div className="row justify-content-center">
              <div className="col-md-10 col-lg-8 col-xl-7">
                <div className="text-center">
                  <span className="d-inline-block h5 lh-1 fw-semibold clr-base overlay-text overlay-text-x"> Browse our articles & resources <span className="overlay-text__content">Blogs</span>
                  </span>
                  <h2 className="mt-5 mb-5"> Take a look at our latest articles and resources </h2>
                  <p className="mx-auto t-short-para"> What follows are some of the comments made by our clients. Don't take it on faith that we said it. Check out what some </p>
                </div>
              </div>
            </div>
          </div>

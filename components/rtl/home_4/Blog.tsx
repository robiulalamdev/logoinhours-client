            ...
            <div className="blog-post-1 blog-post-1--xl">
              ...
              <div className="blog-post-1__body">
                ...
                <h4 className="mt-5 mb-5">
                  <Link href="blog-details-1" className="t-link d-block clr-heading :clr-base"> أكثر التطورات الهامة في التكنولوجيا التي شهدناها حتى الآن هذا العام </Link>
                </h4>
              ...
              <li>
                <div className="blog-post-2">
                  ...
                  <div className="blog-post-2__content">
                    <ul className="list list-row list--divider">
                      <li>
                        <Link href="blog-details-1" className="t-link d-inline-block clr-base :clr-base fw-md"> اصطناعي ذكاء </Link>
                      </li>
                      <li>
                        <div className="group group-xs group-row align-items-center">
                    ...
                    <h5 className="mt-3">
                      <Link href="blog-details-1" className="t-link d-block clr-heading :clr-base"> لماذا نحن نحب التكنولوجيا - ويجب عليك أيضًا! </Link>
                    </h5>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div className="blog-post-2">
                  ...
                  <div className="blog-post-2__content">
                    ...
                    <h5 className="mt-3">
                      <Link href="blog-details-1" className="t-link d-block clr-heading :clr-base"> يصنع شركتك أفضل مع حلول خدمات الويب </Link>
                    </h5>
                  </div>
                </div>
              </li>
              <li>
                <div className="blog-post-2">
                  ...
                  <div className="blog-post-2__content">
                    ...
                    <h5 className="mt-3">
                      <Link href="blog-details-1" className="t-link d-block clr-heading :clr-base"> أ انظر إلى تأثير التكنولوجيا اللاسلكية على المؤسسة </Link>
                    </h5>
                  </div>
                </div>
              </li>

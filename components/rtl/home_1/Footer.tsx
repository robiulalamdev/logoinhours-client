            ...
            <div className="footer-info__content">
              <div className="group group-row group-sm align-items-center">
                <div className="icon-box icon-box--lg circle bg-secondary flex-shrink-0">
                  <img src="/images/icon-15.png" alt="image" className="img-fluid" />
                </div>
                <div className="group group-xxs flex-grow-1">
                  <h5>عنوان</h5>
                  <p>457 ، جوراندي لوس أنجلوس ، الولايات المتحدة الأمريكية</p>
                </div>
              </div>
              <div className="group group-row group-sm align-items-center">
                <div className="icon-box icon-box--lg circle bg-secondary flex-shrink-0">
        ...
        <div className="container">
          <div className="row g-4">
            <div className="col-md-6 col-xl-3 order-md-1">
              ...
              <p className="mb-6 clr-light t-short-para"> نحن نتعامل مع خدمات تكنولوجيا المعلومات الاحترافية من Aspects. نزيد من نجاح الأعمال مع التكنولوجيا ، جعل تكنولوجيا المعلومات جزءًا من عملك ، خدمات تقنية المعلومات الممتازة. </p>
            ...
            <div className="col-sm-6 col-md-4 col-xl-2 order-md-3">
              <h5 className="clr-light mb-10"> خدمات تكنولوجيا المعلومات </h5>
            ...
            <div className="col-sm-6 col-md-4 col-xl-2 order-md-4">
              <h5 className="clr-light mb-10"> يدعم </h5>
            ...
            <div className="col-sm-6 col-md-4 col-xl-2 order-md-5">
              <h5 className="clr-light mb-10"> رابط سريع </h5>
              <ul className="list list-xs">
                <li>
            ...
            <div className="col-sm-6 col-xl-3 order-md-2 order-xl-5">
              <h5 className="clr-light mb-10"> النشرة الإخبارية </h5>

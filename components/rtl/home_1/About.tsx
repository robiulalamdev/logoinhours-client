        ...
        <div className="row justify-content-xxl-between">
          <div className="col-lg-6 col-xxl-5">
            <div className="section__gap-bottom pb-lg-0 position-sticky top-0">
              <span className="d-block h5 lh-1 fw-semibold clr-base"> اكتشف شركتنا </span>
              <h2 className="mt-2 mb-4"> نحن نحب تقديم خدمات تكنولوجيا معلومات فائقة للشركات. </h2>
              <p className="mb-8 t-short-para"> تقدم إيتشيكس مجموعة متنوعة من السلع والخدمات المتعلقة بتكنولوجيا المعلومات ، مثل تطوير الويب وخدمات التسويق الرقمي وتطوير تطبيقات الأجهزة المحمولة. </p>
              <ul className="list">
                <li>
                  <div className="group group-row group-sm justify-content-between align-items-center mb-1">
                    <span className="d-inline-block clr-heading flex-shrink-0"> استشارات تكنولوجيا المعلومات </span>
                    <span className="d-inline-block clr-heading flex-shrink-0"> 25% </span>
                  </div>
                ...
                <li>
                  <div className="group group-row group-sm justify-content-between align-items-center mb-1">
                    <span className="d-inline-block clr-heading flex-shrink-0"> محطة عمل افتراضية </span>
                    <span className="d-inline-block clr-heading flex-shrink-0"> 50% </span>
                  </div>
                  <div className="progress progress--secondary">
                ...
                <li>
                  <div className="group group-row group-sm justify-content-between align-items-center mb-1">
                    <span className="d-inline-block clr-heading flex-shrink-0"> خدمة تكنولوجيا المعلومات المدارة </span>
                    <span className="d-inline-block clr-heading flex-shrink-0"> 75% </span>
                  </div>
                  <div className="progress progress--secondary">
              ...
              <div className="group group-md group-row flex-wrap mt-12">
                ...
                <div className="group group-row align-items-center flex-shrink-0">
                  <div className="icon-box icon-box--sm icon-box--light-outline circle bg-neutral clr-base">
                    <span className="material-symbols-rounded mat-icon size-32 solid"> alarm </span>
                  </div>
                  <div className="group group-0">
                    <p className="clr-heading sm-text">فتح وإغلاق الوقت</p>
                    <p className="clr-heading fw-md">8:00 ص - 6:00 م</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-6">
            <figure className="about-company-1__img" data-cues="fadeIn">
              ...
              <figcaption className="about-company-1__img-wrapper">
                ...
                <span className="about-company-1__img-subtitle"> سنوات من الخبرة </span>
              </figcaption>
            </figure>
          </div>
        </div>

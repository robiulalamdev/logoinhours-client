              ...
              <div className="col-md-10 col-lg-8 col-xl-7">
                <div className="text-center">
                  ...
                  <p className="mx-auto t-short-para">
                    {" "}
                    فيما يلي بعض التعليقات التي أدلى بها عملاؤنا. لا تؤمن أننا
                    قلها. تحقق مما قاله بعض عملائنا السابقين.{" "}
                  </p>
                </div>
              </div>
            </div>
                ...
                <SwiperSlide>
                  <div className="feedback-card-1">
                    ...
                    <p>
                      ...
                      لم أندم على ذلك العثور على حلول النقطة 2 عاجلاً. هذه
                      المجموعة لي ، لذا فأنا متردد في كتابتها. هذا هو عملي فريق!{" "}
                    </p>
                  ...
                  <div className="feedback-card-1">
                    ...
                    <div className="group group-md group-row align-items-center">
                      ...
                      <div className="flex-grow-1">
                        ...
                        <p className="sm-text"> من المحدودة. </p>
                      </div>
                    </div>
                  </div>
                </SwiperSlide>
